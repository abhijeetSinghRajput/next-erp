                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="grid gap-2">
                                    <div className="flex items-center justify-between">
                                        <Label htmlFor="studentId" className={undefined}>Student Id</Label>
                                        <Link href={"/forgot-password"} className="text-sm text-muted-foreground font-medium underline-offset-4 hover:underline">
                                            Forgot your id?
                                        </Link>
                                    </div>
                                    <div className="relative rounded-md">
                                        ...
                                        <Input
                                            ...
                                            className={`h-11 rounded-lg focus-visible:ring-2 pl-9 bg-input/30 ${errors.studentId ? "ring-2 ring-destructive" : ""}`} type={undefined} />
                                    </div>
                                    {errors.studentId && (
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <div className="relative rounded-md">
                                        ...
                                        <Input
                                            ...
                                            className={`h-11 rounded-lg focus-visible:ring-2 px-9 bg-input/30 ${errors.password ? "ring-2 ring-destructive" : ""
                                                }`}
                                        />
                                        <Button
                                            type="button"
                                            ...
                                            onClick={() => setShowPassword((prev) => !prev)} size={undefined}                    >
                                ...
                                <div className="grid gap-2">
                                    ...
                                    <div className="relative rounded-md">
                                        ...
                                        <Input
                                            ...
                                            autoComplete="off"
                                            className={`h-11 rounded-lg focus-visible:ring-2 pl-9 bg-input/30 ${errors.captcha ? "ring-2 ring-destructive" : ""}`} type={undefined} />
                                        <Button
                                            type="button"
                                            variant="ghost"
                                            className="text-muted-foreground rounded-l-none px-2 h-full absolute top-0 right-0"
                                            onClick={getCaptcha}
                                            disabled={loadingCaptcha} size={undefined}                    >
                                            <RefreshCw
                                ...
                                <Button
                                    ...
                                    className="w-full h-11 rounded-lg" variant={undefined} size={undefined}                >
                                    Login
                                    {loggingIn && (
